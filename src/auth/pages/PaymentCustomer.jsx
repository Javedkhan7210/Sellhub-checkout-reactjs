...
export default function PaymentCustomer() {
    ...
    const fetchProduct = async () => {
      try {
        ...
        const response = await fetch(
          `https://apipayment.sellhub.net/api/checkout/product/${transactionData?.Ids}`,
          {
            headers: {
        ...
        if (
          ...
          setTimeout(() => {
            ...
            navigate(`/auth/success-info`, {
              state: {
                ...
                amount: totalAmount ?? calculateTotal(),
                total: productPrice,
                tax: taxAmount,
          ...
          setTimeout(() => {
            ...
            navigate("/auth/payment-declined", {
              state: {
                orderId: transactionData?.transactionId,
                email:transactionData?.email, // You can get this from form data
  ...
  const handleSuccessModalClose = () => {
    ...
    navigate(`/auth/payment-success/${transactionData?.transactionId}`, {
      state: {
        orderData: modalData?.details,
        product: product,
      },
    });
  };
               ...
               <div className="bg-[rgb(24_24_27/_0.5)] backdrop-blur-sm rounded-xl shadow-lg p-6 relative z-10 w-full">
                 ...
                 <div className="flex justify-between items-center">
                   ...
                   <div className="flex justify-between items-center">
                     ...
                     <span className="text-white">${product?.price?.toFixed(2) || "1.00"}</span>
                   </div>
                   <div className="flex justify-between items-center">
