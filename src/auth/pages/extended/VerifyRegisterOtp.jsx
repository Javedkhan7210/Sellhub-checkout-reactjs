...
const VerifyRegisterOtp = () => {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      setLoading(false);
      toast.error(err.response.data.errors?.[0] ?? 'An error occurred. Please try again.');
      setError(err.response.data.errors?.[0] ?? 'An error occurred. Please try again.');
    }
  };
